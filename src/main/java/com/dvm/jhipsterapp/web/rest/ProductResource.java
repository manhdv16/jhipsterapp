...
import com.dvm.jhipsterapp.repository.ProductRepository;
import com.dvm.jhipsterapp.service.ProductService;
import com.dvm.jhipsterapp.service.RedisService;
...
/**
 * REST controller for managing {@link com.dvm.jhipsterapp.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public ResponseEntity<List<ProductDTO>> getAllProducts(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        if (redisService.getValue("getAllProducts") != null) {
            log.info("Getting data from Redis");
            kafkaTemplate.send("group_id_1", "getAllProducts");
            return ResponseEntity.ok().body((List<ProductDTO>) redisService.getValue("getAllProducts"));
        }
        kafkaTemplate.send("group_id_1", "getAllProducts");
        Page<ProductDTO> page = productService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        redisService.setValue("getAllProducts", page.getContent());
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable("id") Long id) {
        ...
        redisService.setValue("getAllProducts", null);
